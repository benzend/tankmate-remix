...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-background text-gray-100">
      ...
      {/* Contact Us */}
      <section className="contact-section bg-slate-950 py-20">
        <div className="container mx-auto max-w-2xl px-8">
          <h2 className="font-serif text-center mb-12 text-4xl font-bold text-white md:text-5xl">
            Get in Touch
          </h2>
          <p className="mx-auto mb-10 max-w-lg text-2xl text-center">
            Reach out with questions, requests, support- pretty much anything that you can think of.
          </p>
          <Form method="post" className="space-y-6">
            <div>
              ...
              <input
                ...
                id="name"
                name="name"
                className="w-full px-4 py-2 rounded bg-slate-800 border border-slate-700 text-white focus:outline-none focus:border-indigo-500"
            ...
            <div className="text-center">
              <button
                type="submit"
                className="inline-block transform rounded bg-indigo-500 px-10 py-2 font-bold text-white transition duration-300 hover:scale-105 hover:bg-indigo-400 disabled:opacity-50"
              >
                Send Message
              </button>
              {actionData?.success && (
