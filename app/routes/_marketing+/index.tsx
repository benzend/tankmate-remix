...
import { MarketingNav } from '#app/components/ui/marketing-nav.js'
import { useOptionalUser } from '#app/utils/user.js'
import { MarketingFooter } from '#app/components/ui/marketing-footer.js';

export default function Index() {
  const user = useOptionalUser();
	return (
		<>
			<MarketingNav user={user || null} />
...
function FeatureCard({
	...
	return (
		<div className="feature-card text-white rounded-lg bg-gradient-to-tl from-blue-950 to-slate-900 p-8 shadow-md transition-all duration-300 hover:shadow-lg">
			<img
				src={imageUrl}
				alt={title}
