...
import { MarketingFooter } from './components/ui/marketing-footer.tsx'
import { MarketingNav } from './components/ui/marketing-nav.tsx'
...
function App() {
  ...
  return (
    <Document
      ...
      env={data.ENV}
    >
      {!location.pathname.includes('/dashboard') && <MarketingNav />}
      <div className="flex-1">
        <Outlet />
      </div>
      {!location.pathname.includes('/dashboard') && <MarketingFooter />}
